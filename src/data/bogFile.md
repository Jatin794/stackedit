...
In case I've asked/allowed you to write something for [https://bog.jatinnagpal.com/](The Bog), this file should serve a reference for the syntax. Basically what I require for my stuff and what you can use for yours.
...
Here goes a guide to stuff you can do in your file which will work. After that you may use the Export as Markdown button (upper right, toggle sidebar -> Import/Export) to get the file to give me for the post. In case you delete anything and forget it, just open this website again in a new browser or private/incognito window and you'll see this website new. Similarly, if you lose your browser data of this site, there's nothing I can do to help recover your content. Everything in here in completely private, and any non-private features are disabled.

Let me know of any feedback, and in case you want alternatives, you can use any markdown or text editor including notepad. I'd recommend adding a markdown extension to VS Code due to the ease of use and extensibility of this option, but use whatever you like as long as the result file is clean and not ugly (So no MS Word).
